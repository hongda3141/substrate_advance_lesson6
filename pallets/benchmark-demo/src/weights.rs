...
//! Autogenerated weights for pallet_benchmark_demo
//!
...
// Executed Command:
// ./target/release/node-template benchmark --chain dev --execution=wasm --wasm-execution=compiled --pallet pallet_benchmark_demo --extrinsic * --steps 50 --repeat 20 --template=./maintain/frame-weight-template.hbs --output=./pallets/benchmark-demo/src/weights.rs
